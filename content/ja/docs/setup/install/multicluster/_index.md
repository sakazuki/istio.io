...
- [Network topologies](/ja/docs/ops/deployment/deployment-models#network-models):
  one or two networks

- [Control plane topologies](/ja/docs/ops/deployment/deployment-models#control-plane-models):
...
See [deployment models](/ja/docs/ops/deployment/deployment-models) for more
information.
{{< /tip >}}